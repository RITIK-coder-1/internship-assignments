...
export default function Feature() {
  return (
    <>
      ...
      <section className="w-vw h-auto flex flex-col justify-center items-center py-20 bg-[#020817]">
        ...
        <div className="w-5/6 h-auto flex flex-col gap-5">
          ...
          <div className="w-full h-auto flex justify-center gap-5 flex-col md:flex-row">
            ...
            <div className="border border-solid border-[#1E293B] w-42 flex flex-col rounded-xl pb-5 overflow-hidden">
              <Image src="/images/save.png" alt="" className="w-full" />
            ...
            {/* Individual feature card */}
            <div className="border border-solid border-[#1E293B] w-42 flex flex-col rounded-xl pb-5 overflow-hidden">
              <Image src="/images/Consecture.png" alt="" className="w-full" />
          ...
          <div className="w-full h-auto flex flex-col md:flex-row justify-between gap-5">
            ...
            {/* Individual feature card */}
            <div className="border border-solid border-[#1E293B] w-42 flex flex-col rounded-xl pb-5 overflow-hidden">
              <Image src="/images/Elit.png" alt="" className="w-full" />
            ...
            {/* Individual feature card */}
            <div className="border border-solid border-[#1E293B] w-42 flex flex-col rounded-xl pb-5 overflow-hidden">
              <Image src="/images/Tempor.png" alt="" className="w-full mb-8" />
            ...
            {/* Individual feature card */}
            <div className="border border-solid border-[#1E293B] w-42 flex flex-col rounded-xl pb-5 overflow-hidden">
              <Image src="/images/Magna.png" alt="" className="w-full" />
