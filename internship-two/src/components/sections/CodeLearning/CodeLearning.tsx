...
import './codeLearning.css'; // Imported the plain CSS file
import Button from '../../common/Button'; // Imported the plain CSS file

const CodeLearning: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const rotateToMouse = (e: MouseEvent) => {
      ...
      const borderColor = '#1095E7';
      const transparent = 'transparent';
      const glowBorderColor = '#1095E7'; 
    ...
    <section id="section"> {/* ID is specified so that the CSS is applied to this specific section only */}
      <div className="card" ref={cardRef}>
        <div>
          <div id="carousel"></div>
          <div id="connect">
              <span style={{color: "#EF476F", fontSize: "1.125rem"}}>Why We're Your</span>
              <h2>Best Code Learning <br /> Choice?</h2>
              <span style={{color: "#808E99", fontSize: "1rem"}}>Choose CodeHelp for an unparalleled coding <br /> experience.</span>
