  ...
  <section className="w-full h-[100%] flex">
    ...
    <div className="absolute w-full h-[96%] flex md:flex-row flex-col items-center md:gap-[4.4rem] gap-[1rem] px-[5rem] z-[1000] mt-12">
      ...
      {/* This is shown on smaller screens, else hidden */}
        <div className="border border-solid border-[#4A2C25] w-[80%] h-auto rounded-full justify-between md:hidden flex my-28 items-center px-4 py-3" style={{backgroundColor: "rgba(30, 30, 33, 0.5)"}}>
          <Tooltip />
          <span className="text-white font-medium">70,000+ Happy Students</span>
        </div>
    </div>
